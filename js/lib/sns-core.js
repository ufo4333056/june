 /*pub-1|2014-05-23 21:04:28*/SNS = window.SNS || {};
...
SNS.provide(function() {
    ...
    var m = {base: "",alias: {base: e + "/snsdk",sns: e + "/snsdk/src"},map: [],load: [],timestamp: Math.floor(new Date().getTime() / 86400000) + 1,skin: true};
    var h = {};
    var j;
    function k(v, t) {
        if (l.isFunction(v)) {
...
SNS.provide(function() {
    var a = function(c, e, f) {
        ...
        if (KISSY.DOM && (KISSY.DOM.test(d, "iframe") || e.ui.isIframe === true)) {
...
SNS.provide(function() {
    var m = "sns-widget", d = "J_TWidget", h = "sns-widget-click";
    function c(n) {
        return function(o) {
            if (o) {
                new o(n)
    ...
    function b(s) {
        if (s._sns_widget_init) {
            return
        }
        s._sns_widget_init = true;
        var o = s.attributes;
        for (var n = 0; n < o.length; n++) {
            ...
            if (/^data-/.test(p)) {
                var q = r && j(r);
                if (!KISSY.isEmptyObject(q)) {
                    q.element = s;
                    SNS.ui(p.slice(5).replace("-", "/"), q)
                }
            }
        }
    }
    ...
    function e(s) {
        var r = document, q = window;
        if (r.readyState === "complete") {
            s()
        } else {
            if (r.addEventListener) {
                r.addEventListener("DOMContentLoaded", s, false);
                ...
                q.attachEvent("onload", s);
                var n = r.documentElement.doScroll;
                if (n) {
                    function p() {
                        try {
                            n("left");
